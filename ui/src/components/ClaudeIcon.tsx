export default function ClaudeIcon({ size = 14, className }: { size?: number; className?: string }) {
  return (
    <svg viewBox="0 0 66 52" fill="none" xmlns="http://www.w3.org/2000/svg" width={size} height={size * (52/66)} className={className} style={{ flexShrink: 0 }}>
